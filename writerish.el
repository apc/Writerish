...
(defun writerish-themes--theme (palette name)
  "Define a variant named NAME using PALETTE."
    (let* ((class '((class color) (min-colors 89)))
           ...
           (bg (plist-get palette :bg)) ; main bg
           (fg (plist-get palette :fg)) ; main fg
           (dim (plist-get palette :dim)) ; comment
           (bg-alt (plist-get palette :bg-alt)) ; bg-alt
           (accent (plist-get palette :accent)) ; darker blue
           (dim-alt (plist-get palette :dim-alt)) ; lighter blue
           (fg-alt (plist-get palette :fg-alt)) ; fg-alt
           (green (plist-get palette :green)) ; green
           (orange (plist-get palette :orange)) ; orange
           (red (plist-get palette :red)) ; red
           ;; (magenta (plist-get palette :magenta))
           (sym (plist-get palette :sym)) ; math
           (fg-dim (plist-get palette :fg-dim)) ; fg-dim (Alternative: #A3A19F)
           (base-weight 'light)
...
;;;; Core
   ;; =============================================================================
;;;;; Base
   `(bold ((,class (:weight ,bold-weight))))
   `(bold-italic ((,class (:weight ,bold-weight :slant italic))))
   `(default ((,class (:foreground ,fg :background ,bg :weight ,base-weight))))
...
;;;;; Core UI
   ...
   `(message-cited-text-1 ((,class (:foreground ,dim :inherit font-lock-comment-face))))
   `(message-cited-text-2 ((,class (:inherit message-cited-text-1))))
   `(message-cited-text-3 ((,class (:inherit message-cited-text-1))))
   `(message-cited-text-4 ((,class (:inherit message-cited-text-1))))
   `(message-header-cc ((,class (:inherit default))))
   `(message-header-name ((,class (:inherit bold))))
...
;;;;; Gnus
   `(gnus-cite-1 ((,class (:inherit message-cited-1))))
   `(gnus-cite-2 ((,class (:inherit message-cited-1))))
   `(gnus-cite-3 ((,class (:inherit message-cited-1))))
   `(gnus-cite-4 ((,class (:inherit message-cited-1))))
   `(gnus-cite-5 ((,class (:inherit message-cited-1))))
   `(gnus-cite-6 ((,class (:inherit message-cited-1))))
   `(gnus-cite-7 ((,class (:inherit message-cited-1))))
   `(gnus-cite-8 ((,class (:inherit message-cited-1))))
   `(gnus-cite-9 ((,class (:inherit message-cited-1))))
   `(gnus-cite-10 ((,class (:inherit message-cited-1))))
   `(gnus-cite-11 ((,class (:inherit message-cited-1))))
   `(gnus-header-content ((,class (:foreground ,dim :italic t))))
   `(gnus-header-from ((,class (:inherit default))))
   `(gnus-header-name ((,class (:foreground ,dim :inherit bold))))
   `(gnus-header-subject ((,class (:inherit bold))))
...
;;;;; Help
   ...
   `(help-key-binding ((,class (:foreground ,accent :underline nil :overline nil :slant normal :inherit bold))))
...
;;;;; Mu4e
   ...
   `(mu4e-contact-face ((,class (:inherit default))))
   `(mu4e-context-face ((,class (:foreground ,dim))))
   `(mu4e-flagged-face ((,class (:foreground ,fg))))
   `(mu4e-header-face ((,class (:foreground ,fg))))
   `(mu4e-header-field-face ((,class (:inherit bold))))
   `(mu4e-header-highlight-face ((,class :background ,dim-alt :extend t)))
   `(mu4e-header-key-face ((,class (:inherit bold))))
   `(mu4e-header-marks-face ((,class (:foreground ,accent :inherit bold))))
   `(mu4e-header-value-face ((,class (:inherit shadow))))
   `(mu4e-highlight-face ((,class (:foreground ,accent :inherit mu4e-header-face))))
   `(mu4e-special-header-value-face ((,class (:inherit default))))
   `(mu4e-header-face ((,class (:inherit default))))
   `(mu4e-forwarded-face ((,class (:inherit mu4e-header-face))))
   `(mu4e-region-code ((,class (:box (:color ,accent)))))
   `(mu4e-replied-face ((,class :foreground ,fg-dim :inherit mu4e-header-face)))
   `(mu4e-unread-face ((,class :foreground ,fg :weight bold :inherit mu4e-header-face)))
...
;;;;; Org mode
   ...
   `(org-code ((, class (:inherit bold :box (:line-width (1 . -1) :color ,dim) :background ,bg-alt))))
   ...
   `(org-tag ((,class (:foreground ,dim :weight normal))))
